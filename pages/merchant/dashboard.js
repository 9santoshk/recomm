  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { data } = await axios.get(`/api/merchant/summary`);
    ...
    <Layout title="Merchant Dashboard">
      <div className="grid  md:grid-cols-4 md:gap-5">
        <div>
          <ul>
            <li>
              <Link href="/merchant/dashboard" className="font-bold">
                Dashboard
              </Link>
            </li>
            <li>
        ...
        <div className="md:col-span-3">
          <h1 className="mb-4 text-xl">Merchant Dashboard</h1>
          {loading ? (
            <div>Loading...</div>
          ) : error ? (
            ...
            <div>
              <div className="grid grid-cols-1 md:grid-cols-4">
                <div className="card m-5 p-5">
                  ...
                  <p>Sales</p>
                  <Link href="/merchant/orders">View sales</Link>
                </div>
                <div className="card m-5 p-5">
...
MerchantDashboardScreen.auth = { merchantOnly: true };
